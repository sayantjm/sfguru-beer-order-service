...
public class BeerServiceImpl implements BeerService {
    ...
    public Optional<BeerDto> getBeerById(UUID uuid) {
        return Optional.of(restTemplate.getForObject(beerServiceHost.concat(BEER_PATH_V1).concat(uuid.toString()), BeerDto.class));
    }

    @Override
    public Optional<BeerDto> getBeerByUpc(String upc) {
        return Optional.of(restTemplate.getForObject(beerServiceHost.concat(BEER_UPC_PATH_V1).concat(upc), BeerDto.class));
    }
